  ...
  return (
    <section className='flex flex-col m-auto gap-10 text-center max-w-7xl items-center justify-center  text-foor-1000'>
      <article className="flex flex-col items-center  gap-4">
        ...
        <Link href="/coaching" className='text-lg text-muted hover:text-primary'>
      ...
      <article className="flex max-md:flex-col gap-6 justify-around  w-full">
        ...
        >
          <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M13.332 18.3333L16.6654 21.6667L23.332 15" stroke="#AD8181" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M18.3333 31.6667C25.6971 31.6667 31.6667 25.6971 31.6667 18.3333C31.6667 10.9695 25.6971 5 18.3333 5C10.9695 5 5 10.9695 5 18.3333C5 25.6971 10.9695 31.6667 18.3333 31.6667Z" stroke="#AD8181" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M34.9987 35.0006L27.832 27.834" stroke="#AD8181" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
          </svg>
        </CardCoaching>
        <CardCoaching
        ...
        >
          <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M3.33203 5H36.6654" stroke="#AD8581" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M35 5V23.3333C35 24.2174 34.6488 25.0652 34.0237 25.6904C33.3986 26.3155 32.5507 26.6667 31.6667 26.6667H8.33333C7.44928 26.6667 6.60143 26.3155 5.97631 25.6904C5.35119 25.0652 5 24.2174 5 23.3333V5" stroke="#AD8581" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M11.668 35.0003L20.0013 26.667L28.3346 35.0003" stroke="#AD8581" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round" />
          </svg>
